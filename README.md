...
```javascript
import scalar2array from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-from-scalar@v0.3.1-deno/mod.js';
```
...
import array2scalar from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-from-scalar@v0.3.1-deno/mod.js';
