...
```javascript
import scalar2array from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-from-scalar@v0.2.0-deno/mod.js';
```
...
import array2scalar from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-from-scalar@v0.2.0-deno/mod.js';
